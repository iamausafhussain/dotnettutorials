namespace AtmFactory
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            IShow showObj = AtmFactoryClass.getObjectShow("show");
            ICreateTransaction transactionObj = AtmFactoryClass.getObjectTransaction("transaction");
                ...
                do
                {
                    ...
                    switch (choice)
                    {
                        ...
                        case 3:
                            ...
                            {
                                transactionObj.createTransaction();
                                transaction_limit++;
                                break;
                            }
                            else
